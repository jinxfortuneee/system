...
<div class="col-md-7 text-right">
  ...
  while ($sy = mysqli_fetch_assoc($query)) { ?>
    <a class='btn btn-success'
      href="rms.php?page=addrecord&id=<?php echo $_GET['id'] ?>&sy=<?php echo $sy['school_year'] ?>&prog=<?php echo $_GET['prog'] ?>"><i
        class="fa fa-plus"> Add Record</i></a>
    <?php
  } ?>
</div>
<br>
      ...
      <div id="fetch-feild">
        <div class="col-md-12">
          ...
          <input type="text" style="width:150px;text-align:center"
            value="<?php echo $row2['PROGRAM'] . ' ' . $row["grade"]; ?>" disabled>
          ...
          <div class="col-xs-9" style="width:690px">
            ...
            <div class="row">
              ...
              <div class="col-xs-4" style="height:53px;border:1px solid black;width:225px">
                ...
                <label for="" style="font-size:6;text-align:center;width:200px;border-bottom:1px solid black">Periodic
                  Rating</label>
                <br>
                <label for=""
                  style="font-size: 11px;;width:43px;border-right:1px solid black;text-align:center">prelim</label>
                <label for=""
                  style="font-size: 11px;;width:55px;border-right: 1px solid black;text-align:center">midterm</label>
                <label for=""
                  style="font-size: 11px;;width:40px;border-right: 1px solid black;text-align:center">prefi</label>
                <label for=""
                  style="font-size: 11px;;width:39px;border-right: 1px solid black;text-align:center">final</label>
              </div>
              <div class="col-xs-1 text-center" style="height:53px;border:1px solid black">
                <br>
                <label for="" style="font-size:6">GPA</label>
                <br>
              </div>
              <div class="col-xs-1 text-center" style="height:53px;border:1px solid black">
                <br>
                <label for="" style="font-size:15px">Units</label>
                <br>
              </div>
            ...
            <div class="row">
              ...
              while ($row2 = mysqli_fetch_assoc($sql2)) {
                ...
                while ($row3 = mysqli_fetch_assoc($sql3)) {
                  ...
                  <div class="col-xs-4"
                    style="border:1px solid black;width:59px;height:20px;font-size:12px;    padding-left: 5px;">
                    <?php echo $row2['1ST_GRADING'] ?>
                  </div>
                  <div class="col-xs-4"
                    style="border:1px solid black;width:56px;height:20px;font-size:12px;    padding-left: 5px;">
                  ...
                  <div class="col-xs-4"
                    style="border:1px solid black;width:54px;height:20px;font-size:12px;    padding-left: 5px;">
                  ...
                  <div class="col-xs-1 text-center"
                    style="border:1px solid black;height:20px;    padding-left: 2px;text-align:center;font-size:12px;width:100px">
          ...
          <div class="col-xs-3">
            ...
            <div class="row">
              ...
              <input type="text" style="width:170px;text-align:center" value="<?php echo $row['TO_BE_CLASSIFIED'] ?>"
                disabled>
              <br><br>
              ...
              <input type="text" style="width:220px;text-align:center" value="<?php echo $row['name'] ?>" disabled>
              <br><br>
