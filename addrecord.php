...
?>
     ...
     <div class="col-md-6">
       ...
       <div class="col-md-6">
         <input type="text" name="class" class="form-control" id ="tbca">
       </div>
       </div>
     </div>
     <div class="col-md-6">
...
?>
             ...
             <td style="width:60px;text-align:center;height:30px;font-size:12px">
              ...
              <td><center><a onclick="remtrr(<?php echo $i ?>)"  id="remtr">X</a></center></td>
              </tr>
