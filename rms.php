  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top " role="navigation">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href=""><b>ACLC </b></a>
      </div>
      <!-- Top Menu Items -->
    ...
    <div id="page-wrapper">
      ...
      <div class="container-fluid">
        ...
        $page = $_GET['page'];
        $pages = array('home', 'Instructor', 'Students', 'subjects', 'student_p', 'instructor_p', 'records', 'record', 'addrecord', 'report', 'program', 'statistical', 'form137', 'list_report', 'student_report', 'users', 'school_year', 'grade', 'advisers', 'database', 'candidates', 'candidates_list', 'candidates_report', 'logs', 'archive');
        if (!empty($page)) {
