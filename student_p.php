<div class="row">
  <div class="col-md-1 text-right">
    <a type="button" class="btn btn-info" href="rms.php?page=Students"><i class="fa fa-chevron-circle-left"
...
while ($row = mysqli_fetch_assoc($sql)) {
  ...
  <div class="container">
    <div class="col-md-12">
      <form method="post"">
         <input type=" hidden" name="id" value="<?php echo $_GET['id'] ?>" <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-md-2 text-center">
        <input type="text" class="form-control input-xs" name="lname" value="<?php echo $row['LASTNAME'] ?>" <br>
        <label style="font-size:10px">(Last name)</label>

      </div>
      <div class="col-md-2 text-center">
        <input type="text" class="form-control input-xs" name="fname" value="<?php echo $row['FIRSTNAME'] ?>" <br>
        <label style="font-size:10px">(First name)</label>

      </div>
      <div class="col-md-2 text-center">
        <input type="text" class="form-control input-xs" name="mname" value="<?php echo $row['MIDDLENAME'] ?>" <br>
    ...
    <div class="row">
      ...
      <div class="col-md-2 text-center">
        <input type="date" class="form-control input-xs" name="dob" value="<?php echo $row['DATE_OF_BIRTH'] ?>" <br>
        <label></label>
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        <input type="text" class="form-control input-xs" name="bp" value="<?php echo $row['BIRTH_PLACE'] ?>" <br>
        <label></label>
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        <textarea type="text" rows="2" class="form-control input-xs"
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        <textarea type="text" rows="2" class="form-control input-xs"
          name="pg"><?php echo $row['PARENT_GUARDIAN'] ?></textarea>
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        <input type="text" class="form-control input-xs" name="pga" value="<?php echo $row['P_ADDRESS'] ?>" <br>
        <label></label>
    ...
    <div class="row">
      ...
      <div class="col-md-2 text-center">
        <input type="number" class="form-control input-xs" name="tny" value="<?php echo $row['TOTAL_NO_OF_YEARS'] ?>" <br>
        <label></label>
    ...
    <div class="row">
      ...
      <div class="col-md-2 text-center">
        <input type="text" class="form-control input-xs" name="sy" value="<?php echo $row['SCHOOL_YEAR'] ?>" <br>
        <label></label>
    ...
    <div class="row">
      ...
      <div class="col-md-2 text-center">
        <input type="number" class="form-control input-xs" name="ave" value="<?php echo $row['GEN_AVE'] ?>" <br>
        <label></label>
